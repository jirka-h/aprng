...
/*
gcc -g -Wall -Wextra -I./ -o AR1_4 AR1_4.c aprng.c tree.c CombGenAPRNG.c -lmylib -ltestu01
valgrind --tool=memcheck -v ./AR1_4
gcc -g -Wall -Wextra -I./ -o AR1_4 AR1_4.c aprng.c tree.c CombGenAPRNG.c   -lmylib -ltestu01 -lefence

gcc -O3 -DNDEBUG -Wall -Wextra -I./ -o AR1_4 AR1_4.c aprng.c tree.c CombGenAPRNG.c fd3.c -lmylib -ltestu01 -lgsl -lgslcblas -lrt
*/
...
int main(int argc, char **argv)
{
  ...
  for(k = 0; k < 3; k++){
    rule[k] = (int) gsl_permutation_get(p, (size_t) k);
  }
  ...
  for (k=0; k<size; ++k) {
    ...
    snprintf(name, sizeof(name), "AR_%d%d%d with %s, %s, %s",  rule[0], rule[1], rule[2], lcg_names[k], lcg_names[k], lcg_names[k]);
    fprintf(stderr, "%s\n", name);
